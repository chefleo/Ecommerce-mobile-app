...
import com.example.simonedigiorgio.ecommerce.Model.Cart;
import com.example.simonedigiorgio.ecommerce.Prevalent.Prevalent;
import com.example.simonedigiorgio.ecommerce.R;
import com.example.simonedigiorgio.ecommerce.ViewHolder.CartViewHolder;
			...
			public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
				...
				if(dataSnapshot.exists()){
					...
					if(shippingState.equals("shipped")){
						...
						recyclerView.setVisibility(View.GONE);
						txtMsg1.setVisibility(View.VISIBLE);
						txtMsg1.setText("Congratulation, your order has been Shipped successfully. Soon it will be verified");
						NextProcessBtn.setVisibility(View.GONE);
